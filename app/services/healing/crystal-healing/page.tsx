    ...
    return (
      <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-purple-50">
        ...
        <section className="relative w-full min-h-[500px] md:min-h-[600px] flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-purple-900 to-violet-800 z-0" />
          ...
          <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 md:px-0 max-w-6xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-purple-100 font-medium drop-shadow-lg mb-8 max-w-4xl">
              Harnessing the Power of Crystals for Healing and Balance
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-gradient-to-r from-purple-400 to-violet-500 text-white font-bold px-8 py-4 rounded-xl shadow-2xl hover:from-purple-500 hover:to-violet-600 transition-all transform hover:scale-105 text-lg">
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl p-8 shadow-xl">
              <h2 className="text-2xl font-bold text-purple-800 mb-6">About Crystal Healing</h2>
              <p className="text-gray-700 leading-relaxed text-lg mb-6">
                {/* TODO: Replace with actual content from JSON */}
                Crystal Healing uses the natural energy and vibrational properties of crystals to promote 
                physical, emotional, and spiritual healing. Each crystal has unique properties that can 
                help balance your energy field and support your healing journey.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                <div className="bg-purple-50 p-6 rounded-xl">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li>• Energy field balancing</li>
                    <li>• Chakra alignment</li>
                    <li>• Natural healing support</li>
                  </ul>
                </div>
                <div className="bg-violet-50 p-6 rounded-xl">
                  <h3 className="font-semibold text-violet-800 mb-3">Duration & Price</h3>
                  <p className="text-2xl font-bold text-violet-700">₹2,500</p>
                  <p className="text-gray-600">75 minutes session</p>
                </div>
              </div>
            </div>
          </div>
